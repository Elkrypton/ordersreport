...
def manufacturer_detail(request, pk):
    ...
    qr_code = generate_qr_code("http://127.0.0.1:8000/manufacturer/{}".format(pk))

    #if manufacturer.owner != request.user:
        #raise Http404
    #qr_code = generate_qr_code(f"Manufacturer {pk}")
    return render(request, "manufacturer_detail.html", {"manufacturer": manufacturer, "qr_code": qr_code})
